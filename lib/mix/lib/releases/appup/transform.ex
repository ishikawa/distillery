defmodule Mix.Releases.Appup.Transform do
  @moduledoc """
  ...
  for all `:update` instructions, and would look like [the example module](https://github.com/bitwalker/distillery/blob/master/test/support/purge_transform.ex).
  """
